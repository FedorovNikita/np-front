...
function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {
  ...
  $smtp_user = 'napoleoninfo@napoleonit.com'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = 'aeVoh7ix'; // Пароль для авторизации на SMTP-сервере
  $mail_from = 'napoleoninfo@napoleonit.com'; // Ящик, с которого отправляется письмо
